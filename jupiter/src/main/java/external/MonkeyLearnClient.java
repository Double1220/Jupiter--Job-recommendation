...
public class MonkeyLearnClient {
    private static final String API_KEY = "18d7748dd7b25314f87353a54217114f7afc3b34";// make sure change it to your api key.
    ...
    //可以在别的地方用到这个函数
    //外面的list 对应text长度  里面的list是每个string的keywords
    ...
    //这个函数把JSON array 转换成List<List<String>>
